...
- SUPPORT_USERNAME — username менеджера (по умолчанию: `semyonp88`, без @)
- MANAGER_CHAT_ID — chat_id менеджера для отправки сообщений (если не задан, используется chat_id покупателя если он менеджер)
